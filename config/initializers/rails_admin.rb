RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Vliner', 'Admin']
  ...
  # config.excluded_models << [Service, ServiceStation, Station]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Service, ServiceStation, Station]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :station, :belongs_to_association
  #   field :slugs, :has_many_association        # Hidden
  #   field :slug, :has_one_association        # Hidden
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
  #   field :cached_slug, :string
  #   field :departs_platform, :string
  #   field :notes, :text
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :departs_at, :integer
  #   field :departs_at_label, :string
  #   field :arrives_at, :integer
  #   field :arrives_at_label, :string
  #   field :sort, :integer
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   # Sections:
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :services, :has_many_association
  #   field :slugs, :has_many_association        # Hidden
  #   field :slug, :has_one_association        # Hidden
  #   # Found columns:
  #   field :id, :integer
